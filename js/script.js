...
function validarCodigo() {
  ...
  document.getElementById('tipoCodigoInput').textContent = resultado.tipoCodigoInput;
  document.getElementById('tipoBoleto').textContent = resultado.tipoBoleto;
  document.getElementById('codigoBarras').textContent = resultado.codigoBarras;
  document.getElementById('linhaDigitavel').textContent = resultado.linhaDigitavel;
  document.getElementById('vencimento').textContent = resultado.vencimento;
  document.getElementById('valor').textContent = resultado.valor;
...
function limparResult() {
  ...
  document.getElementById('tipoCodigoInput').textContent = '';
  document.getElementById('tipoBoleto').textContent = '';
 ...
 */
digitosVerificadores = (codigo, mod) => {
  codigo = codigo.replace(/[^0-9]/g, '');
  switch (mod) {
    case 10:
 ...
 */
codBarras2LinhaDigitavel = (codigo, formatada) => {
  codigo = codigo.replace(/[^0-9]/g, '');
 ...
 */
calculaDVCodBarras = (codigo, posicaoCodigo, mod) => {
  codigo = codigo.replace(/[^0-9]/g, '');
 ...
 */
validarCodigoComDV = (codigo, tipoCodigo) => {
  codigo = codigo.replace(/[^0-9]/g, '');
  let tipoBoleto;
